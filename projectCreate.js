import { showProjectModules } from "./index.js";
    ...
    projects.innerHTML = "";//providing preprovided data
      ...
      for (let i = 0; i < project.length; i++) {
        ...
        projects.appendChild(button);
          ...
          showingButton(showBtn.value,showBtn)
...
const showingButton =(showMeButtonValue,showBtn)=>{
  let showBtnValue = showMeButtonValue

  showBtn.addEventListener("click", function (e) {
    e.preventDefault();
    console.log(showBtnValue); // Log the value of the clicked "project-details" button
    // Perform any other actions related to the "project-details" button here
    
      showProjectModules(showBtnValue)//providing data avout array and showbtn value
